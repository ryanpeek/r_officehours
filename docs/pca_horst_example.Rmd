...
Read it in: 
```{r}
ca_pb <- read_csv("https://github.com/allisonhorst/esm244-w2020-lab2/blob/master/pca-keys/ca_pollution_burden.csv?raw=true")
ca_dem <- read_csv("https://raw.githubusercontent.com/allisonhorst/esm244-w2020-lab2/master/pca-keys/ca_census_demographics_2010.csv")
```
